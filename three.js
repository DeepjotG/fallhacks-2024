...
orbit.minDistance = 10; // Prevents zooming in too close
...
const PointLighting = new THREE.PointLight(0xffffff, 8, 200, 0.5);
...
textureLoader.load(sun, function (sunTexture) {
  ...
  const glowGeo = new THREE.SphereGeometry(16.5, 100, 100); // Slightly larger sphere for aura effect
